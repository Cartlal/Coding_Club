            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transform transition-all duration-700 delay-500 opacity-0 animate-fade-up">
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-3">
                  ...
                  <svg className="w-5 h-5 text-cyan-400 opacity-100 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-1 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
